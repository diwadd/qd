...
if __name__ == "__main__":
    ...
    train_data_files = sf.get_data_files(file_type="png", data_type="train", color="green")

    sf.load_single_image(train_data_files[0])

    example_id = "0a00aab2-bbbb-11e8-b2ba-ac1f6b6435d0"
