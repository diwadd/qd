...
if __name__ == "__main__":
    ...
    # sf.convert_ndjson_simplified_data_into_numpy_arrays(ndjson_file_list, 100)

    sf.convert_ndjson_simplified_data_into_numpy_arrays(["test_simplified.csv"], 100, data_type="test")
